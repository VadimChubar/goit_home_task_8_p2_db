...
def fill_data():
    disciplines = ['Вища математика', 'Історія', 'Економіка', 'Триботехніка', 'Філосоіфя', 'Матеріалознавство',
                    'Менеджмент', 'Електротехніка', 'Теоритична механіка']
    ...
    def seed_grades():
        ...
        end_date = datetime.strptime('2023-05-29', '%Y-%m-%d')
